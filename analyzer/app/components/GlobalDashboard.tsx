...
export const GlobalDashboard = ({ globalStats, mmrHistory, mmrHistoryByDay, chartMode, setChartMode }) => {
	if (!globalStats || globalStats.games === 0) {
		return (
			<div className="w-full min-h-[400px] mb-10 bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 p-12 flex flex-col items-center justify-center min-h-[350px] opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]">
