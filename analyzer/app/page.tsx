	...
	return (
		<main className="flex flex-col p-8 bg-gray-900 text-white min-h-screen font-sans relative overflow-x-hidden">
          ...
          `}} />
			...
			<div className={`w-full max-w-7xl mx-auto mb-8 transition-all duration-500 ease-in-out ${(selectedDeck || isProcessing) ? 'blur-md opacity-40 scale-[0.98] pointer-events-none' : ''}`}>
